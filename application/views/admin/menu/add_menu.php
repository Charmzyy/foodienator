<div class="conatiner">
    <form action="<?php echo base_url().'admin/menu/create_menu';?>" method="POST" id="myForm" name="myForm"
        ...
        <h3 class="mb-3 text-center">Add Clothes Items</h3>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Enter Item name" value="<?php echo set_value('name'); ?>">
...
<script>
    ...
    const validate = () => {
        ...
        if (resnameVal === "--Select Shop--") {
            setErrorMsg(resname, 'select shop name');
        } else {
            setSuccessMsg(resname);
        }
        if (dishnameVal === "") {
            setErrorMsg(dishname, 'item name cannot be blank');
        } else {
