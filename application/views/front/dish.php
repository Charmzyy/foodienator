    ...
    <div class="container res-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                Uzuntu offering best clothing feels visit uzuntu stores
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title"><?php echo $cloth['name']; ?></h4>
                        <h4 class="text-muted"><b>$<?php echo $cloth['price']; ?></b></h4>
                    </div>
                    <p class="card-text"><?php echo $cloth['about']; ?></p>
                    <a href="<?php echo base_url().'Dish/addToCart/'.$cloth['d_id']; ?>" class="btn btn-primary"><i
